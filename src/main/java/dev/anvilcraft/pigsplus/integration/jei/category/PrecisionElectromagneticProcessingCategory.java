...
public class PrecisionElectromagneticProcessingCategory implements IRecipeCategory<RecipeHolder<PrecisionElectromagneticProcessingRecipe>> {
    ...
    public PrecisionElectromagneticProcessingCategory(IGuiHelper helper) {
        ...
        title = Component.translatable("gui.anvilcraft_pigsplus.category.precision_electromagnetic_processing");
    ...
    public void setRecipe(
        IRecipeLayoutBuilder builder, RecipeHolder<PrecisionElectromagneticProcessingRecipe> recipeHolder, IFocusGroup focuses) {
        PrecisionElectromagneticProcessingRecipe recipe = recipeHolder.value();
    ...
    public void getTooltip(
        ...
        if (mouseX >= 72 && mouseX <= 90) {
            ...
            if (mouseY >= 34 && mouseY <= 53) {
                ...
                tooltip.add(Component.translatable("gui.anvilcraft_pigsplus.category.precision_electromagnetic_processing.need_activated")
