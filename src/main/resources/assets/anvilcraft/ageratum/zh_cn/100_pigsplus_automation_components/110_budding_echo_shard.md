...
> 幽匿物质展现出了极强的转化性，但在回响碎片上却未体现这一点，也许可以试着让它接触一些相似的晶体结构。
> 让紫水晶母岩与回响碎片接触后，生成了一种被称为”回响母岩”的物质，其对周边物质具有强大的转化能力
...
- 收到随机刻时，会尝试将 4 格以内的方块转化为<ref item="minecraft:sculk"/>，并在其上概率生成幽匿系列方块
