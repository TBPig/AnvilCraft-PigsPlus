...
import dev.anvilcraft.pigsplus.network.PortableWirelessChargerUpdatePacket;
...
public class PortableWirelessChargerScreen extends AbstractContainerScreen<PortableWirelessChargerMenu> {
    ...
    private @Nullable PortableWirelessChargerSlider slider;
    private List<Integer> sliderValues = List.of(0);
    private int lastValidValue;
    private int maxPower;

    public PortableWirelessChargerScreen(PortableWirelessChargerMenu menu, Inventory inventory, Component title) {
    ...
    protected void init() {
        ...
        this.slider = new PortableWirelessChargerSlider(
            8 + offsetX,
            31 + offsetY,
            144,
            this.sliderValues,
    ...
    private void setValueFromSlider(int value) {
        ...
        if (this.valueInput != null) {
            ...
            PacketDistributor.sendToServer(new PortableWirelessChargerUpdatePacket(value));
        }
    }
    ...
    private void onValueChanged(String value) {
        ...
        if (this.valueInput != null) {
            PacketDistributor.sendToServer(new PortableWirelessChargerUpdatePacket(clamped));
        }
    }
    ...
    protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        ...
        guiGraphics.drawString(
            ...
            Component.translatable(
                "screen.anvilcraft_pigsplus.portable_wireless_charger.value",
    ...
    private static final class PortableWirelessChargerSlider extends Slider {
        private List<Integer> values;

        private PortableWirelessChargerSlider(int x, int y, int length, List<Integer> values, Callback<Integer> callback) {
